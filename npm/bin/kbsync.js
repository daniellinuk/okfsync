...
if (!bin) {
  ...
  console.error(
    [
      ...
      `vendor/ has: ${found}`,
      "Tried KBSYNC_BIN, platform package (okfsync-darwin-arm64 / linux / windows), versioned vendor/, and monorepo cargo build.",
      "Fix: bun add -g okfsync after a multi-platform release, or download the matching",
      "  GitHub Release asset, or from this repo:",
